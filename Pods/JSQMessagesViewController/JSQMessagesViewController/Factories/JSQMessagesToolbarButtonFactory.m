...
//    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
    ...
    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 34.0f, 34.0f)];
       UIImage *btnImage = [UIImage imageNamed:@"sendimage"];
    [accessoryButton setImage:btnImage forState:UIControlStateNormal];
    [accessoryButton setImage:btnImage forState:UIControlStateHighlighted];
...
+ (UIButton *)defaultSendButtonItem
{
   ...
   // [sendButton setTitle:sendTitle forState:UIControlStateNormal];i
